     ...
     <c:if test="${songList==null}">
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
      		<c:if test="${etc.profilename!=null}">
		    	<img src="/AllEars/profileSave/${etc.profilename}" alt="/Allears/img/allears.jpg" class="w3-left w3-circle w3-margin-right" style="width:80px">
		    	</c:if>
		    	<c:if test="${etc.profilename==null}">
		    	<img src="/AllEars/img/allears.jpg" alt="/Allears/img/allears.jpg" class="w3-left w3-circle w3-margin-right" style="width:80px">
		    	</c:if>
