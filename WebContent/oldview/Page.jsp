...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="#" class="w3-bar-item w3-button w3-padding-large w3-theme-d4"><i class="fa fa-home w3-margin-right"></i>All Ears</a>
    ...
    <div class="w3-col m2">
      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <hr>
		 <p class="w3-center">
         	<i class="fa fa-user w3-large w3-margin-right"> 50</i>
            <i class="fa fa-users w3-large w3-margin-right"> 100</i>
         </p>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> TrackMaker</p>
         <p><i class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i> Seoul </p>
         <p><i class="fa fa-birthday-cake fa-fw w3-margin-right w3-text-theme"></i> October 6, 1993</p>
        </div>
        <br>
      </div>
      <br>
        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              <h6 class="w3-opacity">Upload your Song</h6>
              <p contenteditable="true" class="w3-border w3-padding">Status: Feeling Blue</p>
              <button type="button" class="w3-button w3-theme"><i class="fa fa-chain"></i> </button>
